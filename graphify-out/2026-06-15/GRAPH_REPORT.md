...
## Summary
- 1412 nodes · 2387 edges · 156 communities (120 shown, 36 thin omitted)
...
3. `build_router()` - 25 edges
4. `saveAsambleaState()` - 21 edges
5. `request()` - 20 edges
6. `seed_user_in()` - 18 edges
7. `login()` - 17 edges
8. `test_state()` - 16 edges
9. `seed_conjunto()` - 16 edges
...
- 1-file cycle: `backend/api/src/domains/conjuntos/dto.rs -> backend/api/src/domains/conjuntos/dto.rs`
- 1-file cycle: `backend/api/src/domains/conjuntos/handlers.rs -> backend/api/src/domains/conjuntos/handlers.rs`
- 1-file cycle: `backend/api/src/domains/conjuntos/models.rs -> backend/api/src/domains/conjuntos/models.rs`
- 1-file cycle: `backend/api/src/domains/conjuntos/repo.rs -> backend/api/src/domains/conjuntos/repo.rs`
- 1-file cycle: `backend/api/src/domains/notificaciones/dto.rs -> backend/api/src/domains/notificaciones/dto.rs`
- 1-file cycle: `backend/api/src/domains/notificaciones/handlers.rs -> backend/api/src/domains/notificaciones/handlers.rs`
- 1-file cycle: `backend/api/src/domains/notificaciones/models.rs -> backend/api/src/domains/notificaciones/models.rs`
- 1-file cycle: `backend/api/src/domains/notificaciones/repo.rs -> backend/api/src/domains/notificaciones/repo.rs`
- 1-file cycle: `backend/api/src/domains/pagos/dto.rs -> backend/api/src/domains/pagos/dto.rs`
- 1-file cycle: `backend/api/src/domains/pagos/handlers.rs -> backend/api/src/domains/pagos/handlers.rs`
- 1-file cycle: `backend/api/src/domains/pagos/models.rs -> backend/api/src/domains/pagos/models.rs`
- 1-file cycle: `backend/api/src/domains/pagos/repo.rs -> backend/api/src/domains/pagos/repo.rs`
- 1-file cycle: `backend/api/src/domains/parqueadero/dto.rs -> backend/api/src/domains/parqueadero/dto.rs`
...
Cohesion: 0.05
Nodes (6): GET(), GET(), GET(), GET(), GET(), { auth, signIn, signOut, handlers }

### Community 3 - "Analytics Request Retry"
Cohesion: 0.08
Nodes (24): dependencies, @auth/prisma-adapter, @google/generative-ai, gsap, @gsap/react, @hookform/resolvers, lucide-react, @mmmike/web-push (+16 more)

### Community 4 - "Minified Server Bundle"
Cohesion: 0.07
Nodes (20): POST(), vapidKeys, GET(), MOCK_CLASIFICADOS, POST(), db, proxyCache, GET() (+12 more)
...
Cohesion: 0.09
Nodes (7): FeedItem, CelebrationModalProps, ContentActionModalProps, MODULES, SearchContext, SearchModalProps, SUGGESTIONS
...
Cohesion: 0.14
Nodes (14): devDependencies, @cloudflare/next-on-pages, eslint, eslint-config-next, prisma, tailwindcss, @tailwindcss/postcss, @types/node (+6 more)
...
Cohesion: 0.31
Nodes (4): ProfileContent(), useTheme(), BrandedFooter(), BrandedFooterProps
...
Cohesion: 0.16
Nodes (41): AppState, Router, String, Result, main(), AppState, Method, Option (+33 more)
...
Cohesion: 0.12
Nodes (34): AuthUser, bearer_token(), cookie_token(), AppState, Option, Result, Rol, Self (+26 more)

### Community 42 - "Next.js Request Handler"
Cohesion: 0.11
Nodes (27): ApiResult, AreaComun, DateTime, DbConn, NaiveDate, Option, String, Utc (+19 more)

### Community 51 - "Minified Error Logging"
Cohesion: 0.67
Nodes (3): sha256(), supabase, verifyWeightedVoting()
...
Cohesion: 0.15
Nodes (27): DateTime, EstadoParqueadero, From, Option, Parqueadero, RondaParqueadero, Self, String (+19 more)

### Community 62 - "Next.js Request Handler"
Cohesion: 0.16
Nodes (29): ApiResult, AppState, AuthUser, Json, Option, Path, State, Uuid (+21 more)
...
Cohesion: 0.21
Nodes (23): ApiResult, DbConn, EstadoParqueadero, Option, Parqueadero, RondaParqueadero, String, TipoCeldaParqueadero (+15 more)
...
Cohesion: 0.22
Nodes (19): AreaComunDto, ApiResult, AppState, AuthUser, Json, Path, State, Uuid (+11 more)
...
Cohesion: 0.20
Nodes (15): BigDecimal, From, Option, Rol, Self, String, TipoUnidad, Unidad (+7 more)
...
Cohesion: 0.28
Nodes (15): DateTime, EstadoParqueadero, Option, String, TipoCeldaParqueadero, TipoRegistroParqueadero, TipoVehiculo, Utc (+7 more)

### Community 93 - "Minified Error Logging"
Cohesion: 0.25
Nodes (11): Option, Result, Self, String, Vec, Config, ConfigError, parse_origins() (+3 more)

### Community 94 - "Cookies and URL State"
Cohesion: 0.40
Nodes (14): ApiResult, DbConn, Option, String, Unidad, Usuario, Uuid, bootstrap_unidad() (+6 more)
...
Cohesion: 0.37
Nodes (12): ApiResult, DbConn, Notificacion, Option, PushSubscription, Uuid, Vec, create_notificacion() (+4 more)

### Community 97 - "Stream and Header Handling"
Cohesion: 0.32
Nodes (9): Claims, issue(), issue_and_verify_round_trip(), verify(), wrong_secret_is_unauthorized(), ApiResult, Rol, String (+1 more)
...
Cohesion: 0.26
Nodes (8): Footer(), Hero(), slides, Navbar(), useViewTransition(), ViewTransitionContext, ViewTransitionContextType, ViewTransitionProvider()
...
Cohesion: 0.20
Nodes (6): inter, jetbrainsMono, metadata, montserrat, plusJakartaSans, viewport
...
Cohesion: 0.39
Nodes (8): DateTime, Option, Rol, String, Utc, Uuid, NuevoUsuario, Usuario
...
Cohesion: 0.52
Nodes (5): Arc, Config, DbPool, Self, AppState
...
Cohesion: 0.33
Nodes (5): Providers(), Theme, ThemeContext, ThemeContextType, ThemeProvider()
...
Cohesion: 0.50
Nodes (3): 008 — Comunicaciones: anuncios, documentos, directorio, Notes, Purpose

### Community 129 - "Telemetry Metrics API"
Cohesion: 0.50
Nodes (3): 009 — Solicitudes (PQRS) & Trámites, Notes, Purpose

### Community 130 - "Postgres Connection Handling"
Cohesion: 0.50
Nodes (3): 010 — Clasificados & Inmuebles, Notes, Purpose

### Community 131 - "Diagnostics & Logging"
Cohesion: 0.50
Nodes (3): 011 — Chat (user↔admin) & Citofonía, Notes, Purpose
...
## Knowledge Gaps
- **356 isolated node(s):** `pnpm`, `version`, `include`, `exclude`, `Result` (+351 more)
...
- **What is the exact relationship between `Reservas (Amenity Booking) Routes` and `Photo: aerial night view of futuristic clubhouse/event hall in residential complex`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `Error` connect `Next.js Request Handler` to `Stream and Header Handling`, `Task Queue Concurrency`, `Minified Vendor Code`, `Gemini Chat Client`, `WebRTC Peer Connections`, `Minified Debug Utilities`, `WebRTC Peer Connections`, `Minified Helper Functions`, `Next.js Rendering Pipeline`, `Next.js Request Handler`, `Realtime Channel Presence`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Are the 21 inferred relationships involving `build_router()` (e.g. with `main()` and `change_password_flow()`) actually correct?**
  _`build_router()` has 21 INFERRED edges - model-reasoned connections that need verification._
