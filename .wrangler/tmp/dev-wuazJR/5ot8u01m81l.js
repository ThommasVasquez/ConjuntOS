...
// .wrangler/tmp/pages-BBkL62/bundledWorker-0.9956535593408284.mjs
...
var ce = /* @__PURE__ */ __name2((e, t, s, a) => {
  if (t && typeof t == "object" || typeof t == "function") for (let r of re(t)) !oe.call(e, r) && r !== s && H(e, r, { get: /* @__PURE__ */ __name2(() => t[r], "get"), enumerable: !(a = ne(t, r)) || a.enumerable });
  return e;
}, "ce");
var V = /* @__PURE__ */ __name2((e, t, s) => (s = e != null ? se(ie(e)) : {}, ce(t || !e || !e.__esModule ? H(s, "default", { value: e, enumerable: true }) : s, e)), "V");
var x;
var p = q(() => {
  x = { collectedLocales: [] };
});
...
async function J(e) {
  ...
  try {
    ...
    switch (e.method) {
      ...
      case "POST": {
        let i = globalThis[ye], n = /* @__PURE__ */ __name2(async () => {
          let o = await e.json();
...
function qe() {
  ...
  return new Proxy(globalThis, { get: /* @__PURE__ */ __name2((t, s) => e.has(s) ? e.get(s) : Reflect.get(globalThis, s), "get"), set: /* @__PURE__ */ __name2((t, s, a) => Ee.has(s) ? Reflect.set(globalThis, s, a) : (e.set(s, a), true), "set") });
}
__name(qe, "qe");
__name2(qe, "qe");
...
// .wrangler/tmp/pages-BBkL62/5ot8u01m81l.js
...
// .wrangler/tmp/bundle-LjZdXK/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-LjZdXK/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=5ot8u01m81l.js.map
