    ...
    <div ref={containerRef} className="min-h-screen flex flex-col p-6 pt-16 pb-32 overflow-x-hidden relative gap-8">
         ...
         <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-4">
               ...
               <button 
                 ...
                 className="w-full bg-linear-to-r from-accent to-purple-600 py-4 rounded-[22px] font-bold text-white shadow-xl shadow-accent/20 active:scale-[0.98] transition-all flex items-center justify-center gap-3 cursor-pointer"
               >
      ...
      <section className="fade-up flex flex-col gap-6">
         <div className="flex justify-between items-center px-1">
            <h2 className="text-text font-display text-lg font-bold tracking-tight">Activos en el Conjunto</h2>
            ...
            {visitors.filter(v => v.status === 'ACTIVO').map((visitor) => (
              <div key={visitor.id} className="liquid-glass-card rounded-[28px] p-5 flex items-center justify-between border border-border hover:border-accent/20 transition-all">
                <div className="flex items-center gap-4">
                   ...
                   <div>
                     <h4 className="text-text font-bold text-base leading-none mb-1.5">{visitor.name}</h4>
                     <div className="flex items-center gap-3">
           ...
           <div className="relative w-full max-w-sm bg-primary border border-border rounded-[40px] shadow-[0_30px_100px_rgba(0,0,0,0.8)] overflow-hidden animate-in zoom-in-95 slide-in-from-bottom-10 duration-400">
              <div className="p-8 flex flex-col items-center gap-6">
                 ...
                 <div className="flex flex-col items-center text-center gap-2">
                    <h3 className="text-2xl font-display font-bold text-text tracking-tight">Invitación Digital</h3>
                    <p className="text-text/50 text-xs px-4">Comparte este código con tu invitado para agilizar su ingreso.</p>
                 </div>
