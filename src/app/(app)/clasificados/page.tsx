...
function ClasificadoDetail({ item, onClose }: { item: Clasificado, onClose: () => void }) {
  ...
  return (
    <div ref={modalRef} className="fixed inset-0 z-[70] flex items-end justify-center px-0">
      ...
      <div className="modal-content relative w-full max-w-[430px] h-[85vh] bg-primary dark:bg-[#000000] rounded-t-[40px] overflow-hidden flex flex-col border-t border-border">
         {/* IMAGE HEADER */}
         <div className="relative h-2/5 w-full shrink-0">
            <Image 
              ...
              unoptimized 
            />
            <div className="absolute inset-0 bg-linear-to-t from-primary dark:from-[#000000] via-transparent to-transparent" />
            <button 
              onClick={onClose}
