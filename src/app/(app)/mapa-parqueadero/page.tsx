    ...
    <div className="flex flex-col gap-6 p-6 pt-16 pb-32 min-h-screen">
       ...
       <div className="liquid-glass rounded-3xl p-6 border border-border/40 shadow-2xl relative overflow-hidden">
          ...
          <div className="flex gap-4 mb-6 pt-2 pb-4 border-b border-border/10 overflow-x-auto hide-scrollbar">
             ...
             <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-blue-500/25 border border-blue-500"></div><span className="text-[10px] text-text/60 uppercase font-bold tracking-widest">Reservado</span></div>
          </div>
                ...
                return (
                  <button 
                    ...
                    className={`fade-up relative flex flex-col items-center justify-center gap-2 py-6 rounded-2xl border transition-all active:scale-95
                      ${isLibre ? 'bg-text/5 border-border/40 hover:bg-text/10 text-text/70' : 'bg-accent/10 border-accent/40 shadow-[0_0_15px_rgba(99,102,241,0.1)] dark:shadow-[0_0_15px_rgba(217,70,239,0.15)] text-accent'}
                    `}
                  >
             ...
             >
                ...
                <div className="flex flex-col gap-6">
                   ...
                   <button 
                     ...
                     type="submit" 
                     className="w-full bg-linear-to-r from-accent to-violet-600 rounded-2xl py-4 font-bold text-white shadow-xl shadow-accent/20 active:scale-95 transition-all flex items-center justify-center gap-2"
                   >
