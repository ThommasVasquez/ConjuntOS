    ...
    <div ref={containerRef} className="min-h-screen flex flex-col p-6 pt-16 pb-32 overflow-x-hidden relative gap-8">
         ...
         <div className="relative p-8 flex flex-col justify-between min-h-[220px]">
             ...
             <div className="flex justify-between items-end mt-4">
                ...
                <button 
                  ...
                  className="bg-white text-[#171717] px-6 py-3 rounded-2xl font-bold text-sm shadow-xl active:scale-95 transition-all flex items-center gap-2"
                >
      ...
      {selectedPayment && (
        <div className="fixed inset-0 z-200 flex items-center justify-center p-6 animate-in fade-in duration-300">
           <div className="absolute inset-0 bg-primary/95 dark:bg-[#000000]/95 backdrop-blur-3xl" onClick={() => !isProcessing && setSelectedPayment(null)} />
