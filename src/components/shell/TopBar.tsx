...
export default function TopBar() {
  ...
  const isHideTopBar = isHome || pathname === "/reservas" || pathname === "/citofonia" || pathname === "/parqueadero" || pathname === "/cartelera" || pathname === "/inmobiliaria" || pathname === "/pagos" || pathname === "/pqrs";
