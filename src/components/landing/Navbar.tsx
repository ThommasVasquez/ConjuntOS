            ...
            <div className={`transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] flex items-center justify-center text-black dark:text-white ${
              ...
              {scrolled ? (
                ...
                <svg viewBox="0 0 540 180" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full object-contain text-white">
                  ...
                  <path d="M50 82C50 78.6863 52.6863 76 56 76C59.3137 76 62 78.6863 62 82V98H50V82Z" className="fill-white dark:fill-[#0A0A0B]"/>
                  ...
                  <path d="M92 82C92 80.3431 93.3431 79 95 79C96.6569 79 98 80.3431 98 82V89H92V82Z" className="fill-white dark:fill-[#0A0A0B]"/>
