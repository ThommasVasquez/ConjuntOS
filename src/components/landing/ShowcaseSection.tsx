    ...
    const ctx = gsap.context(() => {
      gsap.fromTo(
        ...
        { x: -50, opacity: 0 },
        {
          ...
          duration: 1,
          ease: "power3.out",
          scrollTrigger: { trigger: ".showcase-left", start: "top 80%" },
        },
      );
      ...
      gsap.fromTo(
        ...
        { y: 30, opacity: 0, scale: 0.9 },
        {
          ...
          delay: 0.4,
          ease: "back.out(1.5)",
          scrollTrigger: { trigger: ".showcase-right", start: "top 70%" },
        },
      );
    }, sectionRef);
    ...
    >
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 relative z-10">
        <div className="showcase-left flex-1 flex flex-col justify-between">
          <div className="mb-12 max-w-md">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-accent/10 border border-accent/20 text-accent text-xs font-bold tracking-widest uppercase mb-4">
              ...
              06 • Ecosistema Conectado
            </div>

            <RevealText
              as="h2"
              className="text-2xl md:text-4xl font-bold text-text font-[family-name:var(--font-serif)] leading-tight"
            >
              Nuestra plataforma está definida por ecosistemas perfectamente
              conectados que irradian eficiencia, seguridad y confianza.
            </RevealText>
          </div>

          <div className="relative rounded-[36px] overflow-hidden border border-text/10 shadow-2xl h-[400px]">
            <Image
              fill
              sizes="(max-width: 768px) 100vw, 50vw"
              src="/img/craft-tablet.webp"
              alt="Pagos digitales con Nequi"
              className="object-cover"
            />
            <div className="absolute bottom-0 inset-x-0 bg-black/90 backdrop-blur-md p-6 flex items-center justify-between border-t border-white/10">
              <div>
                <p className="text-sm text-white/70 mb-1">Integración Directa</p>
                <h4 className="font-bold text-white text-lg">
                  Pagos Automatizados con Nequi
                </h4>
              </div>
        ...
        <div className="showcase-right flex-1 relative">
          <div className="relative rounded-[36px] overflow-hidden h-full min-h-[600px] border border-text/10 shadow-2xl">
            <Image
              fill
              sizes="(max-width: 768px) 100vw, 50vw"
              src="/img/lobby-entrance.webp"
              alt="Acceso inteligente al conjunto"
              className="object-cover"
            />
          </div>

          <div className="showcase-float absolute bottom-8 right-8 bg-black/90 border border-white/15 backdrop-blur-xl p-5 rounded-3xl shadow-2xl flex items-center gap-4 w-72">
            <div className="relative w-12 h-12 rounded-full bg-accent/10 border border-accent/30 flex items-center justify-center overflow-hidden">
              <Image
                fill
                sizes="48px"
                src="/img/support.webp"
                alt="Soporte al residente"
