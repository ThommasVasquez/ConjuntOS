...
export default function Footer() {
  ...
  return (
    <footer className="bg-primary text-text pt-24 overflow-hidden relative border-t border-text/5">
      {/* Background Orbs */}
      <div className="absolute bottom-0 right-[-10%] w-[500px] h-[500px] bg-text/5 blur-[120px] rounded-full pointer-events-none" />
      
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 mb-24 relative z-10">
        
        {/* Left Col */}
        <div className="col-span-1 md:col-span-2">
          <p className="text-text max-w-sm mb-8 text-sm leading-relaxed font-light">
          ...
          <div className="flex gap-2 max-w-md">
            <input 
              ...
              className="bg-text/5 border border-text/10 rounded-full px-6 py-3.5 text-sm text-text focus:outline-hidden focus:border-accent/40 focus:ring-4 focus:ring-accent/5 w-64 shadow-inner placeholder:text-text"
            />
        ...
        {/* Links */}
        <div>
          <h4 className="font-bold mb-6 font-[family-name:var(--font-serif)] text-text">Plataforma</h4>
          <ul className="space-y-4 text-sm text-text font-light">
        ...
        <div>
          <h4 className="font-bold mb-6 font-[family-name:var(--font-serif)] text-text">Compañía</h4>
          <ul className="space-y-4 text-sm text-text font-light">
      ...
      <div className="w-full flex justify-center overflow-hidden translate-y-12 select-none pointer-events-none">
        <h1 
          className="text-[20vw] font-black leading-none tracking-tighter text-text/[0.015] font-[family-name:var(--font-serif)] uppercase select-none"
      ...
      {/* Very bottom bar */}
      <div className="border-t border-text/5 py-6 px-6 relative z-10 bg-primary">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center text-xs text-text">
