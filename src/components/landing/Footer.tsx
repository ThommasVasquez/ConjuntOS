...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#000000] text-white pt-24 overflow-hidden relative border-t border-white/5">
      {/* Background Orbs */}
      <div className="absolute bottom-0 right-[-10%] w-[500px] h-[500px] bg-[#FFFFFF]/5 blur-[120px] rounded-full pointer-events-none" />
